# Wissenschaftliche Analyse - Tech ohne Nvidia

Benchmark: QQQ  |  Forschungsfrage: Wie stark haengen die Ergebnisse von Nvidia ab?
...
Verwendete Aktien (9): AAPL, MSFT, AMD, GOOGL, META, AMZN, TSLA, INTC, ADBE
Benchmark: QQQ

Rohdaten-Zeitraum: 2019-01-02 bis 2026-07-10 (20790 Zeilen, inkl. QQQ/SPY als Marktdaten-Quelle)

Chronologischer Split (70/15/15, pro Aktie normalisiert nur auf Trainingsstatistiken):

| Split | Zeitraum | Zeilen |
| --- | --- | --- |
| Training | 2019-10-16 - 2024-06-28 | 10647 |
| Validation | 2024-07-01 - 2025-07-03 | 2277 |
| Test | 2025-07-07 - 2026-07-09 | 2286 |
...
| --- | --- | --- | --- | --- | --- |
| Standard-LSTM (Up/Down) | 0.518 | 0.522 | 0.823 | 0.639 | 0.641 (Epoche 1) |
| Outperformance-LSTM (vs. QQQ) | 0.517 | 0.496 | 0.503 | 0.500 | 0.527 |

## 3. Backtest

| Strategie | Rendite | Buy-and-Hold | Differenz | Zeitraum |
| --- | --- | --- | --- | --- |
| Standard-LSTM (Schwelle 0.50) | +36.8% | +58.5% | -21.7% | 2025-08-01 - 2026-07-08 (234 Tage) |
| Outperformance-LSTM Top-5 | +47.2% | +31.0% | +16.2% | 2025-08-01 - 2026-07-09 (235 Tage) |

Sharpe (Outperformance-LSTM, netto=brutto da keine Transaktionskosten modelliert): 1.81. Max Drawdown: -13.9%. Anzahl Trades (Top-K-Wechsel): 609.

Einordnung:

- Der Standard-LSTM zeigt eine deutlich hoehere Recall- als Precision-Rate (0.82 vs. 0.52), was auf eine Tendenz hindeutet, ueberwiegend 'Kaufen'-Signale zu generieren (Klassenungleichgewicht in Richtung der Mehrheitsklasse), statt trennscharf zwischen Auf- und Abwaertsbewegungen zu unterscheiden.
- Die Outperformance-LSTM-Strategie erreicht einen Sharpe von 1.81, was auf ein vergleichsweise gutes Rendite-Risiko-Verhaeltnis im Testzeitraum hindeutet - unabhaengig davon, ob die absolute Rendite die Benchmark schlaegt.
- Die Strategie schlaegt QQQ im Testzeitraum um +16.2% - ein Hinweis darauf, dass die gelernten Muster (Momentum/Relative Staerke gegenueber dem Benchmark) im Testzeitraum tatsaechlich prognostischen Wert hatten.
...
| --- | --- | --- | --- | --- |
| Top-1 | +14.5% | +59.4% | -44.9% | 1.0 |
| Top-2 | +40.0% | +59.4% | -19.4% | 2.0 |
| Top-3 | +34.2% | +59.4% | -25.2% | 3.0 |
| Top-4 | +46.3% | +59.4% | -13.1% | 4.0 |
| Top-5 | +47.2% | +59.4% | -12.2% | 5.0 |

Bestes Top-K: Top-5 (+47.2%). Schwaechstes Top-K: Top-1 (+14.5%). Spannweite zwischen bestem und schwaechstem K: 32.7%.
...
Grundlage: 5 Signalzeitpunkte, 72 Modell-Wahrscheinlichkeiten insgesamt (1 Vorhersage je Aktie und Signaltag).
...
| --- | --- | --- | --- | --- | --- | --- |
| AMD | 100% | 0.49 | 1.0 | 1 | 2 | 5.0T |
| INTC | 100% | 0.38 | 2.0 | 3 | 0 | 5.0T |
| AAPL | 80% | 0.36 | 3.2 | 2 | 0 | 4.0T |
| TSLA | 20% | 0.35 | 4.0 | 1 | 1 | 1.0T |
| MSFT | 0% | 0.33 | 6.0 | 0 | 0 | n/a |
| GOOGL | 0% | 0.34 | 5.6 | 0 | 0 | n/a |
| META | 0% | 0.33 | 7.4 | 0 | 0 | n/a |
| AMZN | 0% | 0.33 | 7.4 | 0 | 0 | n/a |
| ADBE | 0% | 0.32 | 8.4 | 0 | 0 | n/a |
...
Durchschnittliche Umschichtung pro Signaltag: 0.5 Positionswechsel.
...
Portfolio-Rendite: -4.2%, Benchmark-Rendite: +0.4%, Differenz: -4.6%, Max Drawdown: -7.4%.

Orders: 10 gesamt (Kauf 7, Verkauf 3), gehandeltes Volumen $420,097.
...
Standardplots (`output/tech_no_nvda/`): 01_backtest_vs_benchmark.png, 02_top_k_results.png, 03_hourly_alpaca_vs_benchmark.png, 04_daily_alpaca_vs_benchmark.png, 05_signal_selection_analysis.png, 06_signal_probability_distribution.png (optional).
Zusaetzliche Rohdaten-Plots aus der Pipeline selbst (`universe_results/tech_no_nvda/exp_2_lstm/plots/`): Trainingsverlauf, Konfusionsmatrix, kumulativer Backtest, Top-K-Vergleich, Outperformance-Metriken.

## 10. Wissenschaftliches Fazit

Wichtigste Erkenntnisse:

- Die Top-5-Outperformance-LSTM-Strategie erzielt +47.2% gegenueber +31.0% fuer QQQ (+16.2% Differenz, Sharpe 1.81, Max Drawdown -13.9%).
...
- Die kurze Daily-Alpaca-Simulation (5 Tage) zeigt -4.6% Differenz zum Benchmark - bei dieser Stichprobengroesse nur als Plausibilitaetssignal zu werten, nicht als belastbares Live-Ergebnis.
...
Besonderheit von Tech ohne Nvidia: Wie stark haengen die Ergebnisse von Nvidia ab?
